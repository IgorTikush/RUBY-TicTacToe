...
module TicTacToe
    RSpec.describe Board do
        ...
        context "#initialize" do
            it "initialized the board without error" do
            ...
            it "create 3 things in 3 rows by default" do
                board = Board.new
        ...
        context "#set_cell" do
            it "updates the value of the cell object at a (y,x) coordinate" do
        ...
        # context "#draw" do
        #     xit "returns true if all cells are note empty" do
        #         grid = [['1', 'x','o'], ['o', 'x', 'something'], ['x','0','s']]
        #         board = Board.new(grid: grid)
        #         expect(board.draw?).to be true
        #     end

        #     xit "returns false if some of cells are empty" do
        #         grid = [['2', '4','s'], ['s', '3', '4'], ['5','5','']]
        #         board = Board.new(grid: grid)
